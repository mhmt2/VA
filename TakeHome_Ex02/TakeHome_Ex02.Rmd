...
This visualisation shows 2 related views of Punggol's changing demographic. While an animated view allows us to observe in a single chart how Punggol's population shifted over 20 years, a faceted, static view gives us the option of checking details of each age band by year.
