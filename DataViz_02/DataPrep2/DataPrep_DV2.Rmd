...
## Step 6:
Create a new worksheet PCT_WKDAY_TRIPS. Calculate the percentage of each cell by dividing the absolute number of trips in that cell by the row total. 
...
## Step 24
Repeat steps 16 to 23 for the WEEKEND dataset.
...
## Step 26:
To create the first tab in the visualisation create a new dashboard and drag the 4 sheets containing the WEEKDAY and WEEKEND barcharts and chloropleths into the main frame.
...
### Main Tab
```{r}
knitr::include_graphics("images/dataviz7.png")
```

### Weekday OD Matrix Tab

```{r}
knitr::include_graphics("images/dataviz5.png")
```

### Weekend OD Matrix Tab

```{r}
knitr::include_graphics("images/dataviz6.png")
