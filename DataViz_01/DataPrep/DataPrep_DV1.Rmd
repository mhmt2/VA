...
The final Chart 5 should look like this:
...
## Chart 7 - Zoomed in  view of Gender Gap for Young Adults
This chart shows a close up of how the LFPR gap changed for the 20-29 age groups over time.
